...
"The Coffee Shop Sales Analysis project delivers an in-depth review of sales performance, customer behavior, and product trends for a fictional coffee shop chain. The analysis explores key metrics such as total sales, footfall, average bill per person, and product category performance, providing actionable insights for strategic decisions in inventory management, marketing, and customer experience.

This project features an interactive Excel dashboard, enabling users to analyze data across different dimensions, including time of day, day of the week, and store location. Key questions addressed include:

- Identification of top revenue-generating products and categories
- Variations in customer footfall by time and location
- Peak sales hours and their impact on staffing needs
- Comparative analysis of average bill and order sizes across locations

The insights gained from this analysis aim to help the coffee shop chain better understand its customers, optimize product offerings, and enhance operational efficiency."
...
![Coffee Shop Sales Dashboard](https://github.com/AV965/Coffee-Sales-DashBoard---Excel/blob/364e99e789e072595045dd6a7f185ad7540f7212/Screenshot%202024-02-15%20143928.png)
